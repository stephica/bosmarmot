...
func addPackagesFlags() {
	packagesDo.Flags().StringVarP(&do.ChainURL, "chain-url", "", "tcp://localhost:46657", "chain-url to be used in tcp://IP:PORT format (only necessary for cluster and remote operations)")
