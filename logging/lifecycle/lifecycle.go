...
import (
	...
	"code.monax.io/platform/bosmarmot/logging/adapters/stdlib"
	"code.monax.io/platform/bosmarmot/logging/config"
	"code.monax.io/platform/bosmarmot/logging/loggers"
	"code.monax.io/platform/bosmarmot/logging/structure"

	"fmt"

	"code.monax.io/platform/bosmarmot/logging"
